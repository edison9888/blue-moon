...
-(id)initWithDataArray:(NSMutableArray *)array{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
        self=[super initWithFrame:CGRectMake(0, 0, 320, 568-44-20-44)];
    }else{
        self=[super initWithFrame:CGRectMake(0, 0, 320, 480-44-20-44)];
    }
    if (self) {
...
{
    NSLog(@"You clicked one picture!");
    [self.clickDelegate imageClick:data];
}
